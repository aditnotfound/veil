...
const Knowledge = () => {
  ...
  return (
    <PageLayout
      ...
      description="Manage personal notes and files the AI can retrieve as context."
    >
      {error && (
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between p-4 border rounded-xl">
          <div>
            <Label className="text-sm font-medium">Use personal knowledge</Label>
      ...
      <form onSubmit={handleAddNote} className="space-y-3 p-4 border rounded-xl">
        <div>
